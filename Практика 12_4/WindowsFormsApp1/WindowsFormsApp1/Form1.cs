...
namespace WindowsFormsApp1
{
	public partial class Form1 : Form
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			// заправка автомобиля (на 20л)
			double remainingAmount = car.Refuel(20.0);
			if (remainingAmount == 0.0)
			{
				MessageBox.Show("Машина была успешно заправлена.", "Результат заправки");
			}
			else
			{
				MessageBox.Show($"Весь заправочный объем не влез в бак. Оставшийся объем: {remainingAmount} л.", "Результат заправки");
			}
