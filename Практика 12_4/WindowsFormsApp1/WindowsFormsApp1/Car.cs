...
namespace WindowsFormsApp1
{
	internal class Car
	{
		private double tankCapacity = 0.0; // объём бака (в литрах)
		private double amountCapacity = 0.0; // количество бензина (в литрах)
		private double gasolineConsumption = 0.0; // расход бензина на 100 км
		private double mileage = 0.0; // пробег (в километрах)
